...
tokenizer = AutoTokenizer.from_pretrained('bert_classifier', local_files_only=True)

model = AutoModelForSequenceClassification.from_pretrained('bert_classifier', local_files_only=True)
